...
CHECK_CONNECTION_API_V1_SOURCES_SOURCE_ID_CONNECTION_CHECK_POST_SERVERS = {
    CHECK_CONNECTION_API_V1_SOURCES_SOURCE_ID_CONNECTION_CHECK_POST_SERVER_PLATFORM_API: "https://platform.unstructuredapp.io/",
}


class CheckConnectionAPIV1SourcesSourceIDConnectionCheckPostRequestTypedDict(TypedDict):
    source_id: str
    unstructured_api_key: NotRequired[Nullable[str]]


class CheckConnectionAPIV1SourcesSourceIDConnectionCheckPostRequest(BaseModel):
    source_id: Annotated[
...
class CheckConnectionAPIV1SourcesSourceIDConnectionCheckPostResponseTypedDict(
    TypedDict
):
    content_type: str
...
class CheckConnectionAPIV1SourcesSourceIDConnectionCheckPostResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
