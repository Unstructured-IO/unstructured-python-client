...
from unstructured_client.models.shared import (
    encryptedsecret as shared_encryptedsecret,
    secretreference as shared_secretreference,
)
...
class StoreSecretRequest(BaseModel):
    encrypted_secret: Annotated[
        shared_encryptedsecret.EncryptedSecret,
...
class StoreSecretResponseTypedDict(TypedDict):
    content_type: str
    ...
    secret_reference: NotRequired[shared_secretreference.SecretReferenceTypedDict]
...
class StoreSecretResponse(BaseModel):
    ...
    secret_reference: Optional[shared_secretreference.SecretReference] = None
    r"""Successful Response"""
