...
GET_CONNECTION_CHECK_API_V1_SOURCES_SOURCE_ID_CONNECTION_CHECK_GET_SERVER_PLATFORM_API = "platform-api"
r"""Unstructured Platform API"""

GET_CONNECTION_CHECK_API_V1_SOURCES_SOURCE_ID_CONNECTION_CHECK_GET_SERVERS = {
    GET_CONNECTION_CHECK_API_V1_SOURCES_SOURCE_ID_CONNECTION_CHECK_GET_SERVER_PLATFORM_API: "https://platform.unstructuredapp.io/",
}


class GetConnectionCheckAPIV1SourcesSourceIDConnectionCheckGetRequestTypedDict(
    TypedDict
):
    source_id: str
...
class GetConnectionCheckAPIV1SourcesSourceIDConnectionCheckGetRequest(BaseModel):
    source_id: Annotated[
...
class GetConnectionCheckAPIV1SourcesSourceIDConnectionCheckGetResponseTypedDict(
    TypedDict
):
    content_type: str
...
class GetConnectionCheckAPIV1SourcesSourceIDConnectionCheckGetResponse(BaseModel):
    content_type: str
    r"""HTTP response content type for this operation"""
