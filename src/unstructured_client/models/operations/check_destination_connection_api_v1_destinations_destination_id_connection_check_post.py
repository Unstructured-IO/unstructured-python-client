...
CHECK_DESTINATION_CONNECTION_API_V1_DESTINATIONS_DESTINATION_ID_CONNECTION_CHECK_POST_SERVER_PLATFORM_API = "platform-api"
r"""Unstructured Platform API"""

CHECK_DESTINATION_CONNECTION_API_V1_DESTINATIONS_DESTINATION_ID_CONNECTION_CHECK_POST_SERVERS = {
    CHECK_DESTINATION_CONNECTION_API_V1_DESTINATIONS_DESTINATION_ID_CONNECTION_CHECK_POST_SERVER_PLATFORM_API: "https://platform.unstructuredapp.io/",
}


class CheckDestinationConnectionAPIV1DestinationsDestinationIDConnectionCheckPostRequestTypedDict(
    TypedDict
):
    destination_id: str
...
class CheckDestinationConnectionAPIV1DestinationsDestinationIDConnectionCheckPostRequest(
    BaseModel
):
...
class CheckDestinationConnectionAPIV1DestinationsDestinationIDConnectionCheckPostResponseTypedDict(
    TypedDict
):
    content_type: str
...
class CheckDestinationConnectionAPIV1DestinationsDestinationIDConnectionCheckPostResponse(
    BaseModel
):
    content_type: str
    r"""HTTP response content type for this operation"""
