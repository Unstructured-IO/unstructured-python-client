...
class PartitionParameters:
    ...
    chunking_strategy: Optional[ChunkingStrategy] = dataclasses.field(default=UNSET, metadata={'multipart_form': { 'field_name': 'chunking_strategy' }})
    ...
    combine_under_n_chars: Optional[int] = dataclasses.field(default=UNSET, metadata={'multipart_form': { 'field_name': 'combine_under_n_chars' }})
    ...
    encoding: Optional[str] = dataclasses.field(default=UNSET, metadata={'multipart_form': { 'field_name': 'encoding' }})
    ...
    gz_uncompressed_content_type: Optional[str] = dataclasses.field(default=UNSET, metadata={'multipart_form': { 'field_name': 'gz_uncompressed_content_type' }})
    r"""If file is gzipped, use this content type after unzipping"""
    hi_res_model_name: Optional[str] = dataclasses.field(default=UNSET, metadata={'multipart_form': { 'field_name': 'hi_res_model_name' }})
    r"""The name of the inference model used when strategy is hi_res"""
    include_orig_elements: Optional[bool] = dataclasses.field(default=UNSET, metadata={'multipart_form': { 'field_name': 'include_orig_elements' }})
    ...
    max_characters: Optional[int] = dataclasses.field(default=UNSET, metadata={'multipart_form': { 'field_name': 'max_characters' }})
    ...
    new_after_n_chars: Optional[int] = dataclasses.field(default=UNSET, metadata={'multipart_form': { 'field_name': 'new_after_n_chars' }})
    ...
    similarity_threshold: Optional[float] = dataclasses.field(default=UNSET, metadata={'multipart_form': { 'field_name': 'similarity_threshold' }})
    ...
    starting_page_number: Optional[int] = dataclasses.field(default=UNSET, metadata={'multipart_form': { 'field_name': 'starting_page_number' }})
