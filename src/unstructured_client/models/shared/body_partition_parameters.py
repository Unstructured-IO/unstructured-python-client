...
@dataclasses.dataclass
class BodyPartitionParameters:
    UNSET='__SPEAKEASY_UNSET__'
    files: Files = dataclasses.field(metadata={'multipart_form': { 'file': True }})
    r"""The file to extract"""
    chunking_strategy: Optional[Any] = dataclasses.field(default=UNSET, metadata={'multipart_form': { 'field_name': 'chunking_strategy' }})
    ...
    max_characters: Optional[int] = dataclasses.field(default=500, metadata={'multipart_form': { 'field_name': 'max_characters' }})
    ...
    pdf_infer_table_structure: Optional[bool] = dataclasses.field(default=False, metadata={'multipart_form': { 'field_name': 'pdf_infer_table_structure' }})
