...
class SplitPdfHook(SDKInitHook, BeforeRequestHook, AfterSuccessHook, AfterErrorHook):
    ...
    def __init__(self) -> None:
        ...
        self.coroutines_to_execute: dict[str, list[Coroutine[Any, Any, requests.Response]]] = {}
        self.api_responses: dict[str, requests.Response] = {}
    ...
    def before_request(
        ...
        async def call_api_partial(page):
            async with httpx.AsyncClient() as client:
                ...
                response._content = json.dumps(json_response).encode()  # type: ignore
    ...
    def _await_elements(self, operation_id: str, response: requests.Response) -> Optional[list]:
        ...
        self.api_responses[operation_id] = responses
    ...
    def after_error(
        ...
        responses = self.api_responses.get(operation_id)
    ...
    def _clear_operation(self, operation_id: str) -> None:
        ...
        self.api_responses.pop(operation_id, None)
