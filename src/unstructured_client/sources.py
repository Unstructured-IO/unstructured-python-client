...
class Sources(BaseSDK):
    def check_connection_api_v1_sources_source_id_connection_check_post(
        self,
        *,
        request: Union[
            operations.CheckConnectionAPIV1SourcesSourceIDConnectionCheckPostRequest,
            operations.CheckConnectionAPIV1SourcesSourceIDConnectionCheckPostRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> operations.CheckConnectionAPIV1SourcesSourceIDConnectionCheckPostResponse:
        r"""Check Connection
        ...
        **Returns:**
        ...
        if server_url is not None:
            ...
            base_url = operations.CHECK_CONNECTION_API_V1_SOURCES_SOURCE_ID_CONNECTION_CHECK_POST_SERVERS[
                operations.CHECK_CONNECTION_API_V1_SOURCES_SOURCE_ID_CONNECTION_CHECK_POST_SERVER_PLATFORM_API
            ]
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="check_connection_api_v1_sources__source_id__connection_check_post",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "202", "application/json"):
            return operations.CheckConnectionAPIV1SourcesSourceIDConnectionCheckPostResponse(
                dag_node_connection_check=utils.unmarshal_json(
                    http_res.text, Optional[shared.DagNodeConnectionCheck]
                ),
    ...
    async def check_connection_api_v1_sources_source_id_connection_check_post_async(
        self,
        *,
        request: Union[
            operations.CheckConnectionAPIV1SourcesSourceIDConnectionCheckPostRequest,
    ...
    def get_connection_check_api_v1_sources_source_id_connection_check_get(
        self,
        *,
        request: Union[
            operations.GetConnectionCheckAPIV1SourcesSourceIDConnectionCheckGetRequest,
            operations.GetConnectionCheckAPIV1SourcesSourceIDConnectionCheckGetRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> operations.GetConnectionCheckAPIV1SourcesSourceIDConnectionCheckGetResponse:
        r"""Get Connection Check
        ...
        **Returns:**
        ...
        if server_url is not None:
            ...
            base_url = operations.GET_CONNECTION_CHECK_API_V1_SOURCES_SOURCE_ID_CONNECTION_CHECK_GET_SERVERS[
                operations.GET_CONNECTION_CHECK_API_V1_SOURCES_SOURCE_ID_CONNECTION_CHECK_GET_SERVER_PLATFORM_API
            ]
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                base_url=base_url or "",
                operation_id="get_connection_check_api_v1_sources__source_id__connection_check_get",
                oauth2_scopes=[],
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return operations.GetConnectionCheckAPIV1SourcesSourceIDConnectionCheckGetResponse(
                dag_node_connection_check=utils.unmarshal_json(
                    http_res.text, Optional[shared.DagNodeConnectionCheck]
                ),
                status_code=http_res.status_code,
    ...
    async def get_connection_check_api_v1_sources_source_id_connection_check_get_async(
        self,
        *,
        request: Union[
            operations.GetConnectionCheckAPIV1SourcesSourceIDConnectionCheckGetRequest,
