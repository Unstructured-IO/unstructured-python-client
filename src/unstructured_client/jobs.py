...
class Jobs(BaseSDK):
    ...
    def create_job(
        ...
        *,
        request: Union[
            operations.CreateJobRequest, operations.CreateJobRequestTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.CreateJobRequest)
        request = cast(operations.CreateJobRequest, request)
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body_create_job, False, False, "multipart", shared.BodyCreateJob
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return operations.CreateJobResponse(
    ...
    def get_job_details(
        ...
        *,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetJobDetailsRequest)
        request = cast(operations.GetJobDetailsRequest, request)
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return operations.GetJobDetailsResponse(
                job_details=unmarshal_json_response(
                    Optional[shared.JobDetails], http_res
                ),
                status_code=http_res.status_code,
                content_type=http_res.headers.get("Content-Type") or "",
                raw_response=http_res,
    ...
    def get_job_failed_files(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> operations.GetJobFailedFilesResponse:
        r"""Get Job Failed Files
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetJobFailedFilesRequest)
        request = cast(operations.GetJobFailedFilesRequest, request)
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return operations.GetJobFailedFilesResponse(
                job_failed_files=unmarshal_json_response(
                    Optional[shared.JobFailedFiles], http_res
                ),
                status_code=http_res.status_code,
                content_type=http_res.headers.get("Content-Type") or "",
                raw_response=http_res,
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.ListJobsResponse(
                response_list_jobs=unmarshal_json_response(
                    Optional[List[shared.JobInformation]], http_res
                ),
                status_code=http_res.status_code,
                content_type=http_res.headers.get("Content-Type") or "",
                raw_response=http_res,
