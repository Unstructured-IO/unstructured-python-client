...
class BaseSDK:
    ...
    def _build_request_with_client(
        ...
        if security is not None:  # noqa: SIM102
    ...
    def do_request(
        ...
        def do():
            ...
            if utils.match_status_codes(error_status_codes, http_res.status_code):
                ...
                if err is not None:
                    logger.debug("Request Exception", exc_info=True)  # noqa: LOG014
                    raise err
    ...
    async def do_request_async(
        ...
        async def cleanup_cancelled_request(
            req: httpx.Request | None,
            ...
            while True:
                try:
                    ...
                    if cleanup_task.done():
                        ...
                        return
                    logger.debug(
                        "Cancellation cleanup still running after cancellation"
                    )
        ...
        async def do():
            ...
            req = None
            try:
                req = await hooks.before_request_async(
                ...
                await cleanup_cancelled_request(req, None, cancellation)
                raise
            except Exception as e:
                _, e = await hooks.after_error_async(
            ...
            if utils.match_status_codes(error_status_codes, http_res.status_code):
                try:
                    ...
                    await cleanup_cancelled_request(None, http_res, cancellation)
                    raise
                if err is not None:
                    logger.debug("Request Exception", exc_info=True)  # noqa: LOG014
                    raise err
        ...
        if not utils.match_status_codes(error_status_codes, http_res.status_code):
            try:
                http_res = await hooks.after_success_async(
