    ...
    def partition(
        ...
        *,
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(request.partition_parameters, False, False, "multipart", shared.PartitionParameters),
        ...
        if retries == UNSET:
            if self.sdk_configuration.retry_config is not UNSET:
                ...
                retries = utils.RetryConfig("backoff", utils.BackoffStrategy(500, 60000, 1.5, 900000), True)
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.PartitionResponse(elements=utils.unmarshal_json(http_res.text, Optional[List[Dict[str, Any]]]), status_code=http_res.status_code, content_type=http_res.headers.get("Content-Type") or "", raw_response=http_res)
