...
* [create_workflow](#create_workflow) - Create
* [delete_workflow](#delete_workflow) - Delete Wf
* [get_workflow](#get_workflow) - Get Wf
* [list_workflows](#list_workflows) - List Workflows
* [run_workflow](#run_workflow) - Run
* [update_workflow](#update_workflow) - Set Wf
...
with UnstructuredClient() as uc_client:
    ...
    res = uc_client.workflows.create_workflow(request={
        "create_workflow": {
            "destination_id": "<id>",
            "name": "<value>",
            "schedule": shared.CreateWorkflowSchedule.EVERY_12_HOURS,
            "source_id": "<id>",
            "workflow_type": shared.CreateWorkflowWorkflowType.ADVANCED,
        },
    })
