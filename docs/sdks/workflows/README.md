...
with UnstructuredClient() as uc_client:
    ...
    res = uc_client.workflows.create_workflow_channel_api_v1_workflows_workflow_id_notifications_channels_post(request={
        "request_body": {
...
with UnstructuredClient() as uc_client:
    ...
    res = uc_client.workflows.delete_workflow_channel_api_v1_workflows_workflow_id_notifications_channels_channel_id_delete(request={
        "channel_id": "<id>",
...
with UnstructuredClient() as uc_client:
    ...
    res = uc_client.workflows.get_workflow_channel_api_v1_workflows_workflow_id_notifications_channels_channel_id_get(request={
        "channel_id": "<id>",
...
with UnstructuredClient() as uc_client:
    ...
    res = uc_client.workflows.list_workflow_channels_api_v1_workflows_workflow_id_notifications_channels_get(request={
...
with UnstructuredClient() as uc_client:
    ...
    res = uc_client.workflows.update_workflow_channel_api_v1_workflows_workflow_id_notifications_channels_channel_id_patch(request={
...
with UnstructuredClient() as uc_client:
    ...
    res = uc_client.workflows.verify_workflow_channel_api_v1_workflows_workflow_id_notifications_channels_channel_id_verify_post(request={
